...
function processCurrentTemp(weather, index) {
    ...
    const obj = {
        ...
        dayOfWeek: format((weather.list[index].dt * 1000), `eeee`),
        date: format((getLocalTime(weather.city.timezone)), `eeee, do MMM ''yy`),
        time: format((getLocalTime(weather.city.timezone)), `p`),
